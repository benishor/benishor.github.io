...
This post is the story of how they came to be; a follow-up [part 2: components and setup](/posts/hamtools-components-and-setup/) tours each piece and how to run it.
...
That's the story. If you want to run any of it, [part 2](/posts/hamtools-components-and-setup/) takes each component in turn, what it does, how to install and configure it and [part 3](/posts/hamtools-how-it-works/) digs into how the internet CW keying and the logbook sync mesh actually work.
