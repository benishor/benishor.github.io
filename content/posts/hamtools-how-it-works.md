...
---
The first two posts covered [the story](/posts/hamtools-logging-stack/) and [how to set everything up](/posts/hamtools-components-and-setup/). This one is for the curious: the two bits of hamtools I'm most pleased with: keying CW over a jittery network without wrecking the timing and keeping one logbook in sync across every machine with no server.
...
That's the series: [part 1](/posts/hamtools-logging-stack/) for the why, [part 2](/posts/hamtools-components-and-setup/) for the how-to. The projects are all GPL-3.0, with detailed `README` and design-notes (`CLAUDE.md`) in each repo:
